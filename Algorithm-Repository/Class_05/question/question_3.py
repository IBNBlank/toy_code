...
# @Last Modified time: 2018-09-22 11:33:15

# 描述
# 请实现一个Josh课上所介绍的Weighted quick union with path compression，然后完成测试。

# 输入
# 第1行有一个数字，表示最大可能的数字N，N最大为50000。
# 第2行有一个数字n，表示接下来有多少行数据，n最大为100000。
# 第3行到第n+2行，每行有两个数字，表示连接这两个点
# 第n+3行有一个数字m，表示接下来有多少行数据，m最大为80000。
